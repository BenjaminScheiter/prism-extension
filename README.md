...
Prism can be installed manually from this repository without using the Chrome Web Store.
...
Chrome should show `Prism 1.0.46` in the extensions list. Pin it from the Chrome extensions menu if you want quick access to the popup.

To update a manual install, download the latest repo ZIP, replace the old folder, then click **Reload** for Prism on `chrome://extensions`.
